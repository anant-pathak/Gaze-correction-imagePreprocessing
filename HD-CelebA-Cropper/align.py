...
# main
parser.add_argument('--img_dir', dest='img_dir', default='/disk/projectEyes/faceCropper/HD-CelebA-Cropper/data/img_celeba')
parser.add_argument('--save_dir', dest='save_dir', default='/disk/projectEyes/faceCropper/HD-CelebA-Cropper/data/aligned')
parser.add_argument('--landmark_file', dest='landmark_file', default='/disk/projectEyes/faceCropper/HD-CelebA-Cropper/data/landmark.txt')
parser.add_argument('--standard_landmark_file', dest='standard_landmark_file', default='/disk/projectEyes/faceCropper/HD-CelebA-Cropper/data/standard_landmark_68pts.txt')
parser.add_argument('--crop_size_h', dest='crop_size_h', type=int, default=256) #default 572
parser.add_argument('--crop_size_w', dest='crop_size_w', type=int, default=256) #default 572
parser.add_argument('--move_h', dest='move_h', type=float, default=0.12) #default 0.25
...
# others
parser.add_argument('--face_factor', dest='face_factor', type=float, help='The factor of face area relative to the output image.', default=0.8) #default 0.45
parser.add_argument('--align_type', dest='align_type', choices=['affine', 'similarity'], default='similarity')
parser.add_argument('--order', dest='order', type=int, choices=[0, 1, 2, 3, 4, 5], help='The order of interpolation.', default=4)
...
img_names = np.array(['ja.jpg', 'ben.jpg', 'anant_0.jpg'])
